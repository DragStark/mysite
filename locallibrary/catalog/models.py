...
class Book(models.Model):
    ...
    isbn = models.CharField('ISBN', max_length=13, unique=True, help_text=_('13 Characters <a href="https://www.isbn-international.org/content/what-isbn">ISBN number</a>'))
